...
import { effortlesshomeSensor, EArmModes, Dictionary, HomeAssistant } from '../types';
...
export const sensorConfigByType = (modeList: EArmModes[]): Dictionary<Partial<effortlesshomeSensor>> => {
...
export function defaultSensorConfig(stateObj: HassEntity | undefined, modeList: EArmModes[]) {
  ...
  let config: effortlesshomeSensor = {
