...
const Qn=2,Yn=6,Wn=e=>(...t)=>({_$litDirective$:e,values:t});class Xn{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}let Jn=class extends Ge{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.invalid=!1,this.rowRenderer=e=>{const t=Sn(e.description);return this.icons?Te`
    ...
    `}};n([Qe()],Jn.prototype,"label",void 0),n([Qe()],Jn.prototype,"value",void 0),n([Qe()],Jn.prototype,"items",void 0),n([Qe()],Jn.prototype,"clearable",void 0),n([Qe()],Jn.prototype,"icons",void 0),n([Qe({type:Boolean})],Jn.prototype,"disabled",void 0),n([Ye()],Jn.prototype,"_opened",void 0),n([Qe({attribute:"allow-custom-value",type:Boolean})],Jn.prototype,"allowCustomValue",void 0),n([Qe({type:Boolean})],Jn.prototype,"invalid",void 0),n([We("vaadin-combo-box-light",!0)],Jn.prototype,"_comboBox",void 0),Jn=n([Ke("effortlesshome-select")],Jn);const es={};class ts extends Xn{constructor(e){if(super(e),this.previousValue=es,e.type!==Yn)throw new Error("renderer only supports binding to element")}render(e,t){return je}update(e,[t,i]){var a;const n=this.previousValue===es;if(!this.hasChanged(i))return je;this.previousValue=Array.isArray(i)?Array.from(i):i;const s=e.element;if(n){const i=null===(a=e.options)||void 0===a?void 0:a.host;this.addRenderer(s,t,{host:i})}else this.runRenderer(s);return je}hasChanged(e){let t=!0;return Array.isArray(e)?Array.isArray(this.previousValue)&&this.previousValue.length===e.length&&e.every((e,t)=>e===this.previousValue[t])&&(t=!1):this.previousValue===e&&(t=!1),t}}const is=Wn(class extends ts{addRenderer(e,t,i){e.renderer=(e,a,n)=>{Ue(t.call(i.host,n.item,n,a),e,i)}}runRenderer(e){e.requestContentUpdate()}}),as=(e,t)=>is(e,t);let ns=class extends Ge{static get styles(){return h`
      :host {
        display: block;
      }
    `}render(){return Te`
      <slot></slot>
    `}constructor(){super(),this.addEventListener("clickHeader",this.manageSpoilers)}manageSpoilers(e){const t=e.target;t.getAttribute("active")?t.removeAttribute("active"):t.setAttribute("active","true"),this.querySelectorAll("effortlesshome-collapsible-header[active]").forEach((function(e){e!==t&&e.removeAttribute("active")}))}};ns=n([Ke("effortlesshome-collapsible-group")],ns);let ss=class extends Ge{static get styles(){return h`
      :host {
        display: block;
      }
    `}render(){return Te`
      <slot></slot>
    `}};ss=n([Ke("effortlesshome-collapsible-item")],ss);let rs=class extends Ge{constructor(){super(),this.clickHeader=new CustomEvent("clickHeader",{detail:{message:"clickHeader happened."},bubbles:!0,composed:!0}),this.active=!1,this.addEventListener("click",this.handleClick)}handleClick(){this.dispatchEvent(this.clickHeader)}render(){return Te`
    ...
    `}};os=n([Ke("effortlesshome-collapsible-body")],os);let ds=class extends(ut(Ge)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await ht(this.hass),this.sensors=await it(this.hass))}async firstUpdated(){await this._fetchData(),this.selectedArea=Object.keys(this.areas)[0],this.data=Object.assign({},this.areas[this.selectedArea].modes)}render(){return this.data?Te`
      <ha-card>
    ...
    `}};n([Qe({type:Boolean,reflect:!0})],cs.prototype,"narrow",void 0),n([Qe()],cs.prototype,"header",void 0),n([Qe()],cs.prototype,"open",void 0),cs=n([Ke("collapsible-section")],cs);let hs=class extends(ut(Ge)){constructor(){super(...arguments),this.areas={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await tt(this.hass);this.config=e,this.areas=await ht(this.hass),this.selection=e.mqtt}firstUpdated(){(async()=>{await Je()})()}render(){return this.hass&&this.selection?Te`
      <ha-card>
        <div class="card-header">
...
class ms extends Xn{constructor(e){if(super(e),this.et=V,e.type!==Qn)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===V||null==e)return this.ft=void 0,this.et=e;if(e===R)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.et)return this.ft;this.et=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ms.directiveName="unsafeHTML",ms.resultType=1;const us=Wn(ms);let ps=class extends Ge{render(){return Te`
    ...
    `}};n([Qe({type:String})],ps.prototype,"value",void 0),n([Qe({type:Boolean})],ps.prototype,"checked",void 0),n([Qe({type:Boolean})],ps.prototype,"checkmark",void 0),n([Qe({type:Boolean})],ps.prototype,"selectable",void 0),n([Qe({type:Boolean})],ps.prototype,"clickable",void 0),n([Qe({type:Boolean})],ps.prototype,"cancellable",void 0),n([Qe({type:Number})],ps.prototype,"badge",void 0),n([Qe({type:Boolean})],ps.prototype,"table",void 0),ps=n([Ke("effortlesshome-chip")],ps);let gs=class extends Ge{constructor(){super(...arguments),this.value=[]}render(){return this.items?Te`
    ...
    `}};n([Qe()],gs.prototype,"items",void 0),n([Qe()],gs.prototype,"value",void 0),n([Qe({type:Boolean})],gs.prototype,"selectable",void 0),gs=n([Ke("effortlesshome-chip-set")],gs);let vs=class extends Ge{set filters(e){this.filterConfig||(this.filterConfig=e)}shouldUpdate(e){return e.get("filters")&&!this.filterConfig&&(this.filterConfig=e.get("filters")),!0}render(){if(!this.columns||!this.data)return Te``;const e=this.data.filter(e=>this.filterTableData(e,this.filterConfig));return Te`
  ...
  `,n([Qe()],vs.prototype,"hass",void 0),n([Qe()],vs.prototype,"columns",void 0),n([Qe()],vs.prototype,"data",void 0),n([Ye()],vs.prototype,"filterConfig",void 0),n([Ye()],vs.prototype,"filterSelection",void 0),n([Qe({type:Boolean})],vs.prototype,"selectable",void 0),n([We("mwc-menu",!0)],vs.prototype,"_menu",void 0),vs=n([Ke("effortlesshome-table")],vs);let _s=class extends Ge{async showDialog(e){this._params=e,await this.updateComplete}async closeDialog(){this._params&&this._params.cancel(),this._params=void 0}render(){return this._params?Te`
    ...
    `}};n([Qe({attribute:!1})],bs.prototype,"hass",void 0),n([Ye()],bs.prototype,"_params",void 0),n([Qe()],bs.prototype,"areas",void 0),n([Qe()],bs.prototype,"sensors",void 0),n([Qe()],bs.prototype,"automations",void 0),n([Qe()],bs.prototype,"name",void 0),n([Qe()],bs.prototype,"area_id",void 0),n([Qe()],bs.prototype,"selectedArea",void 0),bs=n([Ke("create-area-dialog")],bs);var ys=Object.freeze({__proto__:null,get CreateAreaDialog(){return bs}});let ks=class extends(ut(Ge)){constructor(){super(...arguments),this.areas={},this.sensors={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await ht(this.hass),this.sensors=await it(this.hass),this.automations=await nt(this.hass))}render(){if(!this.hass)return Te``;const e=Object.values(this.areas);e.sort(Ln);const t={actions:{width:"48px"},name:{title:this.hass.localize("ui.components.area-picker.add_dialog.name"),width:"40%",grow:!0,text:!0},remarks:{title:mn("panels.general.cards.areas.table.remarks",this.hass.language),width:"60%",hide:this.narrow,text:!0}},i=Object.values(e).map(t=>{const i=Object.values(this.sensors).filter(e=>e.area==t.area_id).length,a=1==Object.values(e).length?Object.values(this.automations).filter(e=>{var i,a;return(null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).includes(t.area_id))||!(null===(a=e.triggers)||void 0===a?void 0:a.map(e=>e.area).length)}).length:Object.values(this.automations).filter(e=>{var i;return null===(i=e.triggers)||void 0===i?void 0:i.map(e=>e.area).includes(t.area_id)}).length,n=`<a href="${Rn("sensors",{filter:{area:t.area_id}})}">${mn("panels.general.cards.areas.table.summary_sensors",this.hass.language,"number",i)}</a>`,s=`<a href="${Rn("actions",{filter:{area:t.area_id}})}">${mn("panels.general.cards.areas.table.summary_automations",this.hass.language,"number",a)}</a>`;return{id:t.area_id,actions:Te`
      ...
      <ha-card header="${mn("panels.general.cards.areas.title",this.hass.language)}">
        ...
        <effortlesshome-table .columns=${t} .data=${i}>
    ...
    `}};n([Qe({attribute:!1})],ws.prototype,"hass",void 0),n([Ye()],ws.prototype,"_params",void 0),n([Qe()],ws.prototype,"name",void 0),ws=n([Ke("edit-master-dialog")],ws);var As=Object.freeze({__proto__:null,get EditMasterDialog(){return ws}});let $s=class extends(ut(Ge)){constructor(){super(...arguments),this.areas={},this.automations={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){this.hass&&(this.config=await tt(this.hass),this.areas=await ht(this.hass),this.automations=await nt(this.hass),this.data=jn(this.config,["trigger_time","disarm_after_trigger","mqtt","master"]))}firstUpdated(){(async()=>{await Je()})()}render(){var e,t,i,a,n,s,r,o;return this.hass&&this.config&&this.data?"mqtt_configuration"==this.path.subpage?Te`
    ...
    `;var t}modesByArea(e){const t=Object.keys(this.areas).reduce((e,t)=>Object.assign(e,{[t]:Object.entries(this.areas[t].modes).filter(([,e])=>e.enabled).map(([e])=>e)}),{});return e?t[e]:Object.values(t).reduce((e,t)=>e.filter(e=>t.includes(e)))}_SetData(e){if(this.data)for(const[t,i]of Object.entries(e))switch(t){case"always_on":this.data=Object.assign(Object.assign({},this.data),{always_on:1==i}),i&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,use_exit_delay:!1,use_entry_delay:!1,allow_open:!1,auto_bypass:!1}));break;case"use_entry_delay":this.data=Object.assign(Object.assign({},this.data),{use_entry_delay:1==i});break;case"use_exit_delay":this.data=Object.assign(Object.assign({},this.data),{use_exit_delay:1==i}),this.data.type!==vn.Motion||i||(this.data=Object.assign(Object.assign({},this.data),{allow_open:!1}));break;case"arm_on_close":this.data=Object.assign(Object.assign({},this.data),{arm_on_close:1==i}),i&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1,allow_open:!1}));break;case"allow_open":this.data=Object.assign(Object.assign({},this.data),{allow_open:1==i}),i&&(this.data=Object.assign(Object.assign({},this.data),{arm_on_close:!1,always_on:!1}));break;case"auto_bypass":this.data=Object.assign(Object.assign({},this.data),{auto_bypass:1==i}),i&&(this.data=Object.assign(Object.assign({},this.data),{always_on:!1}));break;case"trigger_unavailable":this.data=Object.assign(Object.assign({},this.data),{trigger_unavailable:1==i})}}setMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{modes:this.data.modes.includes(e)?En(this.data.modes,e):Tn(this.data.modes.concat([e]))}))}setBypassMode(e){this.data&&(this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.includes(e)?En(this.data.auto_bypass_modes,e):Tn(this.data.auto_bypass_modes.concat([e]))}))}setType(e){if(!this.data)return;const t=e!=vn.Other?js(this.modesByArea(this.data.area))[e]:{};this.data=Object.assign(Object.assign(Object.assign({},this.data),{type:e}),t)}deleteClick(e){var t,i;(t=this.hass,i=this.item,t.callApi("POST","effortlesshome/sensors",{entity_id:i,remove:!0})).catch(t=>Cn(t,e)).then(()=>{this.cancelClick()})}saveClick(e){if(!this.data)return;const t=[];this.data.new_entity_id&&this.data.new_entity_id==this.data.entity_id&&(this.data=xn(this.data,"new_entity_id")),this.data=Object.assign(Object.assign({},this.data),{auto_bypass_modes:this.data.auto_bypass_modes.filter(e=>this.data.modes.includes(e))}),this.data.area||t.push(mn("panels.sensors.cards.editor.errors.no_area",this.hass.language)),this.data.modes.length||this.data.always_on||t.push(mn("panels.sensors.cards.editor.errors.no_modes",this.hass.language)),this.data.auto_bypass&&!this.data.auto_bypass_modes.length&&t.push(mn("panels.sensors.cards.editor.errors.no_auto_bypass_modes",this.hass.language)),t.length?zn(e,Te`
        ...
        `):ot(this.hass,Object.assign({},this.data)).catch(t=>Cn(t,e)).then(()=>{this.cancelClick()})}cancelClick(){Dn(0,Rn("sensors"),!0)}manageGroupsClick(e){const t=e.target;wn(t,"show-dialog",{dialogTag:"manage-sensor-groups-dialog",dialogImport:()=>Promise.resolve().then((function(){return Ls})),dialogParams:{}})}getSensorGroups(){return Object.keys(this.sensorGroups).map(e=>Object({value:e,name:this.sensorGroups[e].name}))}};Ds.styles=qn,n([Qe()],Ds.prototype,"hass",void 0),n([Qe()],Ds.prototype,"narrow",void 0),n([Qe()],Ds.prototype,"item",void 0),n([Qe()],Ds.prototype,"data",void 0),n([Qe()],Ds.prototype,"showBypassModes",void 0),n([Ye()],Ds.prototype,"entityIdUnlocked",void 0),Ds=n([Ke("sensor-editor-card")],Ds);const Ps=e=>Object.keys(e.modes).filter(t=>e.modes[t].enabled),Hs=e=>{let t=[];return Object.values(e).forEach(e=>{t=[...t,...Ps(e)]}),t=Tn(t),t.sort((e,t)=>{const i=Object.values(yn);return i.findIndex(t=>t==e)-i.findIndex(e=>e==t)}),t},Bs="no_area";let qs=class extends(ut(Ge)){hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){this.hass&&(this.areas=await ht(this.hass),this.sensors=await it(this.hass))}async firstUpdated(){this.path&&2==this.path.length&&"filter"==this.path[0]&&(this.selectedArea=this.path[1])}shouldUpdate(e){const t=e.get("hass");return!t||1!=e.size||!this.sensors||Object.keys(this.sensors).some(e=>t.states[e]!==this.hass.states[e])}render(){return this.hass&&this.areas&&this.sensors?Te`
    ...
    `}};n([Qe()],Rs.prototype,"hass",void 0),n([Qe()],Rs.prototype,"narrow",void 0),n([Qe()],Rs.prototype,"item",void 0),n([Qe()],Rs.prototype,"data",void 0),n([Qe()],Rs.prototype,"repeatCode",void 0),Rs=n([Ke("user-editor-card")],Rs);let Vs=class extends(ut(Ge)){constructor(){super(...arguments),this.users={}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await tt(this.hass);this.data=jn(e,["code_arm_required","code_disarm_required","code_mode_change_required","code_format"]);const t=await at(this.hass);this.users=t}render(){if(!this.hass||!this.data)return Te``;if("new_user"==this.path.subpage)return Te`
    ...
    `}};var cr;n([Qe()],lr.prototype,"hass",void 0),n([Qe()],lr.prototype,"items",void 0),n([Qe({type:Array})],lr.prototype,"value",void 0),n([Qe()],lr.prototype,"label",void 0),n([Qe({type:Boolean})],lr.prototype,"invalid",void 0),lr=n([Ke("effortlesshome-selector")],lr),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(cr||(cr={}));let hr=class extends Ge{constructor(){super(...arguments),this.config={type:bn.Notification,triggers:[{}],actions:[{}]},this.viewMode=cr.UI,this.errors={}}async firstUpdated(){if(await et(),this.areas=await ht(this.hass),this.effortlesshomeConfig=await tt(this.hass),this.item){let e=this.item.actions.map(e=>xn(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Sn(t)&&!Qs(this.areas,this.effortlesshomeConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}}))}if(!Sn(this.config.triggers[0].area)){const e=Qs(this.areas,this.effortlesshomeConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}}render(){var e,t,i,a,n;return this.hass&&this.areas&&this.effortlesshomeConfig?Te`
      <div class="heading">
        ...
        <div class="card-content">
          ...
          ${Object.keys(this.areas).length>1?Te`
                <settings-row .narrow=${this.narrow} .large=${!0}>
                  ...
                  <effortlesshome-select
                    .hass=${this.hass}
                    .items=${Qs(this.areas,this.effortlesshomeConfig).map(e=>Ks(e,this.areas,this.effortlesshomeConfig))}
                    clearable=${!0}
    ...
    `}};var mr;n([Qe({attribute:!1})],hr.prototype,"hass",void 0),n([Qe()],hr.prototype,"narrow",void 0),n([Qe()],hr.prototype,"config",void 0),n([Qe()],hr.prototype,"item",void 0),n([Qe()],hr.prototype,"areas",void 0),n([Qe()],hr.prototype,"effortlesshomeConfig",void 0),n([Qe()],hr.prototype,"viewMode",void 0),n([Qe()],hr.prototype,"errors",void 0),hr=n([Ke("notification-editor-card")],hr),function(e){e[e.Yaml=0]="Yaml",e[e.UI=1]="UI"}(mr||(mr={}));let ur=class extends Ge{constructor(){super(...arguments),this.config={type:bn.Action,triggers:[{}],actions:[{}]},this.viewMode=mr.UI,this.errors={}}async firstUpdated(){if(await et(),this.areas=await ht(this.hass),this.effortlesshomeConfig=await tt(this.hass),this.item){let e=this.item.actions.map(e=>e.entity_id?e:xn(e,"entity_id"));this.config=Object.assign(Object.assign({},this.item),{actions:[e[0],...e.slice(1)]}),this.config.triggers.length>1&&(this.config=Object.assign(Object.assign({},this.config),{triggers:[this.config.triggers[0]]}));let t=this.config.triggers[0].area;Sn(t)&&!Qs(this.areas,this.effortlesshomeConfig).includes(t)?t=void 0:null===t&&(t=0),this._setArea(new CustomEvent("value-changed",{detail:{value:t}})),this._hasCustomEntities()&&(this.viewMode=mr.Yaml)}if(!Sn(this.config.triggers[0].area)){const e=Qs(this.areas,this.effortlesshomeConfig);1==e.length?this._setArea(new CustomEvent("value-changed",{detail:{value:e[0]}})):e.includes(0)&&this._setArea(new CustomEvent("value-changed",{detail:{value:0}}))}!this.item||this.config.triggers[0].area||this.effortlesshomeConfig.master.enabled||(this.errors=Object.assign(Object.assign({},this.errors),{area:!0}))}render(){var e;return this.hass&&this.areas&&this.effortlesshomeConfig?Te`
      <div class="heading">
        <ha-icon-button .path=${Zn} @click=${this._cancelClick} class="icon"></ha-icon-button>
    ...
    `}};n([Qe({attribute:!1})],ur.prototype,"hass",void 0),n([Qe()],ur.prototype,"narrow",void 0),n([Qe()],ur.prototype,"config",void 0),n([Qe()],ur.prototype,"item",void 0),n([Qe()],ur.prototype,"areas",void 0),n([Qe()],ur.prototype,"effortlesshomeConfig",void 0),n([Qe()],ur.prototype,"viewMode",void 0),n([Qe()],ur.prototype,"errors",void 0),ur=n([Ke("automation-editor-card")],ur);let pr=class extends(ut(Ge)){constructor(){super(...arguments),this.areas={},this.getAreaForAutomation=e=>{if(!this.config)return;const t=Qs(this.areas,this.config);let i=e.triggers[0].area;return Sn(i)&&t.includes(i)?i:void 0}}hassSubscribe(){return this._fetchData(),[this.hass.connection.subscribeMessage(()=>this._fetchData(),{type:"effortlesshome_config_updated"})]}async _fetchData(){if(!this.hass)return;const e=await nt(this.hass);this.automations=Object.values(e),this.areas=await ht(this.hass),this.config=await tt(this.hass)}firstUpdated(){var e;this.path.filter&&(this.selectedArea=null===(e=this.path.filter)||void 0===e?void 0:e.area),(async()=>{await Je()})()}render(){if(!this.hass||!this.automations||!this.config)return Te``;if("new_notification"==this.path.subpage)return Te`
