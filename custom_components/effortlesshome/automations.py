...
class AutomationHandler:
    def __init__(self, hass: HomeAssistant):
        ...
        self._subscriptions.append(
            async_dispatcher_connect(hass, "effortlesshome_automations_updated", async_update_config)
        )
        async_update_config()
        ...
        self._subscriptions.append(
            async_dispatcher_connect(self.hass, "effortlesshome_state_updated", async_alarm_state_changed)
        )
    ...
    async def async_execute_automation(self, automation_id: str, alarm_entity: effortlesshomeBaseEntity):
    ...
    async def replace_wildcards_in_string(self, input: str, alarm_entity: effortlesshomeBaseEntity):
